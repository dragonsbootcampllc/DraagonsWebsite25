...
import logoImg from "public/images/identity/Full_Logo.png";
      ...
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 relative w-full gap-8 lg:grid-cols-3">
          <div className="relative w-full z-10">
            ...
            <p className="relative mt-4  text-white/60  block text-lg">Address:</p>
            <p className="relative block text-white/60 text-lg">
                    ...
                    <li key={index}>
                      {link.status && link.url ? (
                        link.url.startsWith("http") ? (
                          <a href={link.url} className="text-gray-200 transition">
                            {link.title}
                          </a>
                        ) : (
                          <Link
