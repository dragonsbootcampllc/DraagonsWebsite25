...
type DialogTriggerProps = {
  ...
  triggerRef?: React.RefObject<HTMLDivElement>;
  setIsPopupOpen?: React.Dispatch<boolean>;
};
      ...
      {isOpen && (
        <>
          <motion.div
            ...
            className='fixed inset-0 h-full z-50  backdrop-blur-sm w-0'
            initial={{ opacity: 0 }}
            animate={{ opacity: 0 }}
            exit={{ opacity: 0 }}
...
function DialogClose({ children, className, variants, size = 24 }: DialogCloseProps) {
