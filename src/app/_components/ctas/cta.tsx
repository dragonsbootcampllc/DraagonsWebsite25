...
export default function () {
  return (
    <div className="w-full px-2 py-20">
        <MagicCard wrapperClassName="size-full py-20" className="relative size-full overflow-hidden m-auto max-w-7xl">
          <div className="flex flex-col items-center justify-center size-full gap-8 py-8 text-center">
            ...
            <div className="flex flex-row gap-4">
              ...
              <Button className="gap-2 flex justify-center items-center" variant={ButtonVariant.Secondary}>
